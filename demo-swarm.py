import subprocess
import time
path_to_SITL_ardupilot = '/home/anonymous/ardupilot'
path_to_launch_file = '/home/anonymous/ROS_stuff/mavros-master/ardupilot_ws/src/swarming/launch'
path_to_template = '/home/anonymous/Desktop'
...
for count in range(1, min(vehicle_count + 1, 11)):
	generator(count, path_to_template, '/home/anonymous/Desktop')
	#+ ' -w' + ' --add-param-file ' + ' home/anonymous/Desktop/param_files/mav_' + str(count) + '.parm'
	subprocess.Popen(['gnome-terminal','-e' ,'sim_vehicle.py -v ArduCopter -I ' + str(count) + ' -w' + ' --add-param-file ' + ' /home/anonymous/Desktop/param_files/mav_' + str(count) + '.parm'], cwd=path_to_SITL_ardupilot)
