...
def ros_connect():
	...
	#subscribers
	rospy.Subscriber("/vehicle2/mavros/global_position/global", NavSatFix, getGPS)
	
	#publishers
	wp_publisher = rospy.Publisher('/vehicle2/mavros/setpoint_raw/global', GlobalPositionTarget, queue_size=1000)
